...
public final class OniGamePlugin extends JavaPlugin implements Listener, CommandExecutor, TabCompleter {
    ...
    @Override public boolean onCommand(CommandSender sender,Command command,String label,String[] a){
        ...
        if(a[0].equalsIgnoreCase("version")){msg(sender,"&dOniGame Runtime &f0.37.2 &7| GUI schema: &fskills 2p / passives 4p &7| Expected RP: &fv37");return true;}
    ...
    private void equipYuukiArmor(Player p){p.getInventory().setHelmet(dyedOniArmor(Material.LEATHER_HELMET,org.bukkit.Color.fromRGB(35,22,48),"&5幽鬼の兜",1220));p.getInventory().setChestplate(dyedOniArmor(Material.LEATHER_CHESTPLATE,org.bukkit.Color.fromRGB(35,22,48),"&5幽鬼の装束",1221));p.getInventory().setLeggings(dyedOniArmor(Material.LEATHER_LEGGINGS,org.bukkit.Color.fromRGB(18,17,24),"&8幽鬼の袴",1222));p.getInventory().setBoots(dyedOniArmor(Material.LEATHER_BOOTS,org.bukkit.Color.fromRGB(52,31,67),"&5幽鬼の足具",1223));}
    ...
    private void equipYuukiArmor(LivingEntity e){e.getEquipment().setHelmet(dyedOniArmor(Material.LEATHER_HELMET,org.bukkit.Color.fromRGB(35,22,48),"&5幽鬼の兜",1220));e.getEquipment().setChestplate(dyedOniArmor(Material.LEATHER_CHESTPLATE,org.bukkit.Color.fromRGB(35,22,48),"&5幽鬼の装束",1221));e.getEquipment().setLeggings(dyedOniArmor(Material.LEATHER_LEGGINGS,org.bukkit.Color.fromRGB(18,17,24),"&8幽鬼の袴",1222));e.getEquipment().setBoots(dyedOniArmor(Material.LEATHER_BOOTS,org.bukkit.Color.fromRGB(52,31,67),"&5幽鬼の足具",1223));}
